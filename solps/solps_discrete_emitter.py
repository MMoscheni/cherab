...
def make_solps_discrete_emitter(solps_mesh, radiation_function,
                                parent = None, step = 0.01, configFile = cfg): # MMM
    """
    ...
    # to be added in configuration file (.json)
    num_limiters = cfg['plasma']['num_limiters']                      # [ - ] 8 limiters = 8 non-limiters
    angular_width_lim = cfg['plasma']['angular_width_limiters']       # [deg] width of the limiters ????
    ...
    for i in range(num_limiters):
        plasma_volume.instance(parent = parent,
                               material = material,
